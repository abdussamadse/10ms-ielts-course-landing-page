...
export default function Right({ courseData }: HeroProps) {
  ...
  return (
    <div className="w-full md:max-w-[330px] lg:max-w-[400px] bg-white absolute right-0 md:top-[50px]">
      <div className="md:sticky md:top-[112px] ">
        <div className="md:border-gray-800 md:rounded md:shadow-sm p-4">
          {/* Video Thumbnail */}
          <div className="hidden md:block">
            <ThumbnailGallery courseData={courseData} />
          </div>
